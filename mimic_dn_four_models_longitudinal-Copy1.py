...
get_ipython().run_line_magic('pip', 'install pyarrow pandas numpy scikit-learn')
get_ipython().run_line_magic('pip', 'install "transformers<=4.30.0" accelerate')
get_ipython().run_line_magic('pip', 'install pytorch-tabular')
get_ipython().run_line_magic('pip', 'install git+https://github.com/RyanWangZf/transtab.git')
