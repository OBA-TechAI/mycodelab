...
results = {
    ...
    "Model":
        "BioBERT EHR-to-text 365d Control",
...
pd.DataFrame(
    ...
    "biobert_365d_control_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "biobert_365d_control_predictions.csv",
    index=False
)

print(
    "\nSaved: biobert_365d_control_results.csv"
)

print(
    "Saved: biobert_365d_control_predictions.csv"
)
