...
# ============================================================
# 5. BUILD NON-TIME-AWARE EHR TEXT
# ============================================================
...
print(
    patient_text[example_id][:500]
)


# ============================================================
# 6. LOAD BIOBERT LOCALLY
# ============================================================
...
BEST_MODEL = (
    "timeaware_clinicalbert_diagtext_365d_best.pt"
)
...
results = {
    ...
    "Model":
        "Time-Aware ClinicalBERT Diagnosis-Text 365d",
...
print("=" * 65)
print(
    "LEAKAGE-SAFE TIME-AWARE CLINICALBERT DIAGNOSIS-TEXT RESULTS"
)
print("=" * 65)
...
pd.DataFrame(
    ...
    "timeaware_clinicalbert_diagtext_365d_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "timeaware_clinicalbert_diagtext_365d_predictions.csv",
    index=False
)

print(
    "\nSaved: timeaware_clinicalbert_diagtext_365d_results.csv"
)

print(
    "Saved: timeaware_clinicalbert_diagtext_365d_predictions.csv"
)
