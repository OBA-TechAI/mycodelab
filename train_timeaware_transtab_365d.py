...
CHECKPOINT_DIR = "./timeaware_transtab_365d_ckpt"
...
print(
    "LEAKAGE-SAFE TIME-AWARE TRANSTAB RESULTS"
)
...
pd.DataFrame(
    ...
    "timeaware_transtab_365d_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "timeaware_transtab_365d_predictions.csv",
    index=False
)


print(
    "\nSaved: timeaware_transtab_365d_results.csv"
)

print(
    "Saved: timeaware_transtab_365d_predictions.csv"
)
