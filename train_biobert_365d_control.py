...
BEST_MODEL = (
    "biobert_diagtext_365d_control_best.pt"
)
...
results = {
    ...
    "Model":
        "BioBERT Diagnosis-Text 365d Control",
...
print("=" * 65)
print(
    "LEAKAGE-SAFE BIOBERT EHR-TO-TEXT CONTROL RESULTS"
)
print("=" * 65)
...
pd.DataFrame(
    ...
    "biobert_diagtext_365d_control_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "biobert_diagtext_365d_control_predictions.csv",
    index=False
)

print(
    "\nSaved: biobert_diagtext_365d_control_results.csv"
)

print(
    "Saved: biobert_diagtext_365d_control_predictions.csv"
)
