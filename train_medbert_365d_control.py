...
BEST_MODEL = "medbert_365d_control_best.pt"
...
pd.DataFrame(
    ...
    "medbert_365d_control_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "medbert_365d_control_predictions.csv",
    index=False
)

print(
    "\nSaved: medbert_365d_control_results.csv"
)

print(
    "Saved: medbert_365d_control_predictions.csv"
)
