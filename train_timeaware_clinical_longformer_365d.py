...
BEST_MODEL = (
    "timeaware_clinical_longformer_365d_best.pt"
)
...
results = {
    ...
    "Model":
        "Time-Aware Clinical Longformer Diagnosis-Text 365d",
...
print(
    "LEAKAGE-SAFE TIME-AWARE CLINICAL LONGFORMER RESULTS"
)
...
pd.DataFrame(
    ...
    "timeaware_clinical_longformer_365d_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "timeaware_clinical_longformer_365d_predictions.csv",
    index=False
)

print(
    "\nSaved: timeaware_clinical_longformer_365d_results.csv"
)

print(
    "Saved: timeaware_clinical_longformer_365d_predictions.csv"
)
