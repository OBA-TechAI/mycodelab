...
BEST_MODEL = (
    "clinicalbert_diagtext_365d_control_best.pt"
)
...
results = {
    ...
    "Model":
        "ClinicalBERT Diagnosis-Text 365d Control",
...
print("=" * 65)
print(
    "LEAKAGE-SAFE CLINICALBERT EHR-TO-TEXT CONTROL RESULTS"
)
print("=" * 65)
...
pd.DataFrame(
    ...
    "clinicalbert_diagtext_365d_control_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "clinicalbert_diagtext_365d_control_predictions.csv",
    index=False
)

print(
    "\nSaved: clinicalbert_diagtext_365d_control_results.csv"
)

print(
    "Saved: clinicalbert_diagtext_365d_control_predictions.csv"
)
