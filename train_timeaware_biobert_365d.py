...
BEST_MODEL = (
    "timeaware_biobert_diagtext_365d_best.pt"
)
...
results = {
    ...
    "Model":
        "Time-Aware BioBERT Diagnosis-Text 365d",
...
print("=" * 65)
print(
    "LEAKAGE-SAFE TIME-AWARE BIOBERT DIAGNOSIS-TEXT RESULTS"
)
print("=" * 65)
...
pd.DataFrame(
    ...
    "timeaware_biobert_diagtext_365d_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "timeaware_biobert_diagtext_365d_predictions.csv",
    index=False
)

print(
    "\nSaved: timeaware_biobert_diagtext_365d_results.csv"
)

print(
    "Saved: timeaware_biobert_diagtext_365d_predictions.csv"
)
