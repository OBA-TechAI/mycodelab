...
df = pd.read_parquet(
    "structured_features_timeaware_365d_safe.parquet"
)
...
BEST_MODEL = (
    "timeaware_fttransformer_365d_best.pt"
)
...
results = {
    ...
    "Model":
        "Time-Aware FT-Transformer 365d",
...
print(
    "LEAKAGE-SAFE TIME-AWARE FT-TRANSFORMER RESULTS"
)
...
pd.DataFrame(
    ...
    "timeaware_fttransformer_365d_results.csv",
    index=False
)
...
pd.DataFrame({
    ...
    "timeaware_fttransformer_365d_predictions.csv",
    index=False
)

print(
    "\nSaved: timeaware_fttransformer_365d_results.csv"
)

print(
    "Saved: timeaware_fttransformer_365d_predictions.csv"
)
